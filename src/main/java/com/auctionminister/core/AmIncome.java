 ...
 * @author wggray
 */
public class AmIncome {

	public AmIncome() {
		super();
	}
	
	public void Apply(long userId, int incType, 
			SqlSession session, double incAmount, String trxRef) throws AmSoException{
		...
		try {
			...
			account.setAccountIndex(incType);
			account.setTrxRef(trxRef);
			account.setAdjustVal(incAmount);
			...
			account.setTrxRef("other income");
