 ...
 * @author wggray
 */
public class RptOpenSalesOrdersAction extends BaseAction {

	private static final long serialVersionUID = 6882595091640522927L;
	private String isSecure = "S";
	
	public RptOpenSalesOrdersAction() {
		super();
	}
	...
	public String execute() throws Exception {
		...
		try {	
				...
				report.RenderReport(parameters, "amopensalesorders.pdf", 
						"com/auctionminister/action/reports/amr_open_sales_orders.jasper");
