 ...
 * @author wggray
 */
public class RptPurchasesByVendorAction extends BaseAction {

	private static final long serialVersionUID = 8422271380381182454L;
	private String isSecure = "S";
	private Date pStartDate = null;
	private Date pEndDate = null;
	
	public RptPurchasesByVendorAction() {
		super();
	}
	...
	public String execute() throws Exception {
		...
		try {	
				...
				report.RenderReport(parameters, "ampurchasesbyvendor.pdf", 
						"com/auctionminister/action/reports/amr_po_by_vendor.jasper");
