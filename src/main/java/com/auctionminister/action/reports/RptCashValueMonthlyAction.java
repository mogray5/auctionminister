 ...
 * @author wggray
 */
public class RptCashValueMonthlyAction extends BaseAction {

	private static final long serialVersionUID = 2119700507953594329L;
	private String isSecure = "S";
	private int pStartYear = 2003;
	private int pEndYear = 2003;
	
	public RptCashValueMonthlyAction() {
		super();
	}
	...
	public String execute() throws Exception {
		...
		try {	
				...
				report.RenderReport(parameters, "amcashvaluemonthly.pdf", 
						"com/auctionminister/action/reports/amr_cash_value_by_month.jasper");
