 ...
 * @author wggray
 */
public class RptNonMerchChargesAction extends BaseAction {

	private static final long serialVersionUID = -4698689865564957857L;
	private String isSecure = "S";
	
	private Date pStartDate = null;
	private Date pEndDate = null;
	
	public RptNonMerchChargesAction() {
		super();
	}
	...
	public String execute() throws Exception {
		...
		try {	
				...
				report.RenderReport(parameters, "amnonmerchcharges.pdf", 
						"com/auctionminister/action/reports/amr_nonmerch_charges.jasper");
