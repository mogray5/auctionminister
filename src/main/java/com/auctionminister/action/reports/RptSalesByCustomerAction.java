 ...
 * @author wggray
 */
public class RptSalesByCustomerAction extends BaseAction {

	private static final long serialVersionUID = 1840637045640150970L;
	private String isSecure = "S";
	private Date pStartDate = null;
	private Date pEndDate = null;
	
	public RptSalesByCustomerAction() {
		super();
	}
	...
	public String execute() throws Exception {
		...
		try {	
				...
				report.RenderReport(parameters, "amsalesbycustomer.pdf", 
						"com/auctionminister/action/reports/amr_sales_by_customer.jasper");
