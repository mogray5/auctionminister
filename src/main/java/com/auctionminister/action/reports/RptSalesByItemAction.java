 ...
 * @author wggray
 */
public class RptSalesByItemAction extends BaseAction {

	private static final long serialVersionUID = 3197443907671670694L;
	private String isSecure = "S";
	private Date pStartDate = null;
	private Date pEndDate = null;
	
	public RptSalesByItemAction() {
		super();
	}
	...
	public String execute() throws Exception {
		...
		try {	
				...
				report.RenderReport(parameters, "amsalesbyitem.pdf", 
						"com/auctionminister/action/reports/amr_sales_by_item.jasper");
