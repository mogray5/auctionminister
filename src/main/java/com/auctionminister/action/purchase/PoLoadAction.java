 ...
 * @author wggray
 */
public class PoLoadAction extends BaseAction {

	private static final long serialVersionUID = -4773468346483593327L;
	...
	public String execute() throws Exception {
		...
		try {	
			...
			poHeader = (PoHeaderData) session.selectOne("GetOpenPoHeader", search);
