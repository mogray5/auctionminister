 ...
 * @author wggray
 */
public class UpDeleteUnmarkedAction extends BaseAction {

	private static final long serialVersionUID = -6738454346444709859L;
	private String isSecure = "S";
	
	public UpDeleteUnmarkedAction() {
		super();
	}
	...
	public String execute() throws Exception {
		...
		try {	
				...
				session.update("DeleteUnmarkedTranLines", dat);
				session.commit();
