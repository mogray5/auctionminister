 ...
 * @author wggray
 */
public class UpDeleteIntegratedAction extends BaseAction {

	private static final long serialVersionUID = -2805205605055046849L;
	private String isSecure = "S";
	
	public UpDeleteIntegratedAction() {
		super();
	}
